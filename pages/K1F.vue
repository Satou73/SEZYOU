      ...
      <v-row dense>
        ...
        <div v-if= "items[1]['lock_status'] == 'open'">
          <v-card
           ...
           height="160"
           light> 
           <v-card-title>第一実習室 </v-card-title>
           <v-card-text>
        ...
        <div v-if= " items[1]['lock_status'] == 'open'">
          <v-card
           ...
           height="160"
           light> 
           <v-card-title>第二実習室 </v-card-title>
           <v-card-text>
             <v-icon mx-auto size="50">mdi-lock-open</v-icon>
           </v-card-text>
          </v-card>
        ...
        <div v-if= " items[0]['lock_status'] == 'open'">
          <v-card
           ...
           height="160"
           light> 
           <v-card-title>流体工学実験室 </v-card-title>
           <v-card-text>
             <v-icon mx-auto size="50">mdi-lock-open</v-icon>
           </v-card-text>
          </v-card>
        ...
        <div v-if= " items[0]['lock_status'] == 'open'">
          <v-card
           ...
           height="160"
           light> 
           <v-card-title>材料強度実験室 </v-card-title>
           <v-card-text>
             <v-icon mx-auto size="50">mdi-lock-open</v-icon>
           </v-card-text>
          </v-card>
        ...
        <div v-if= " items[0]['lock_status'] == 'open'">
          <v-card
           ...
           height="160"
           light> 
           <v-card-title>一般化学実験室 </v-card-title>
           <v-card-text>
             <v-icon mx-auto size="50">mdi-lock-open</v-icon>
           </v-card-text>
          </v-card>
