      ...
      <v-row dense>
        ...
        <div v-if= " items[0]['lock_status'] == 'open'">
          <v-card
            ...
            height="160"
          　light>
          <v-card-title>情報演習室</v-card-title>
          <v-card-text>
        ...
        <div v-if= " items[0]['lock_status'] == 'open'">
          <v-card
            ...
            height="160"
          　light>
          <v-card-title>工学デザイン室</v-card-title>
          <v-card-text>
             <v-icon center size="50">mdi-lock-open</v-icon>
          </v-card-text>
          </v-card>
        ...
        <div v-if= " items[0]['lock_status'] == 'open'">
          <v-card
            ...
            height="160"
          　light>
          <v-card-title>分析化学実験室</v-card-title>
          <v-card-text>
             <v-icon center size="50">mdi-lock-open</v-icon>
          </v-card-text>
          </v-card>
        ...
        <div v-if= " items[0]['lock_status'] == 'open'">
          <v-card
            ...
            height="160"
          　light>
          <v-card-title>物理実験室</v-card-title>
          <v-card-text>
             <v-icon center size="50">mdi-lock-open</v-icon>
          </v-card-text>
          </v-card>
        ...
        <div v-if= " items[0]['lock_status'] == 'open'">
          <v-card
            ...
            height="160"
          　light>
          <v-card-title>電気情報応用<br>実験室</v-card-title>
          <v-card-text>
             <v-icon center size="50">mdi-lock-open</v-icon>
          </v-card-text>
          </v-card>
